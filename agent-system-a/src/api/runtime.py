...
class RagRuntime:
    def __init__(
        ...
        arabic_translation_openrouter_api_key: str | None = None,
        arabic_translation_openrouter_model: str = "qwen/qwen3.5-flash-02-23",
        arabic_translation_openrouter_url: str = "https://openrouter.ai/api/v1",
        ...
        self.query_translator = build_query_translator(
            ...
            openrouter_api_key=arabic_translation_openrouter_api_key,
            openrouter_model=arabic_translation_openrouter_model,
            openrouter_url=arabic_translation_openrouter_url,
            groq_api_key=groq_api_key,
